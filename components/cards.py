                ...
                dbc.CardBody(
                    [
                        html.Div([
                            ...
                            html.Br(),
                            ColorPaletteSelectionCard('custom', selected_palettes[0]),
                            html.Br(),
                            ColorPaletteSelectionCard('heatmap', selected_palettes[1]),
                            html.Br(),
                            ColorPaletteSelectionCard('hydrophobicity', selected_palettes[2]),
                            html.Br(),
                            ColorPaletteSelectionCard('membranetopology', selected_palettes[3]),
                            html.Br(),
                            ColorPaletteSelectionCard('conservation', selected_palettes[4]),
                            html.Br(),
                            ColorPaletteSelectionCard('disorder', selected_palettes[5]),
                            html.Br(),
                            ColorPaletteSelectionCard('secondarystructure', selected_palettes[6]),
                            html.Br(),
                        ])
                    ]
                )
